    ...
    >
      <transition mode="out-in" name="fade">
        ...
        <PhMoon
          ...
          :size="16"
        />
        <PhCircleHalf v-else key="auto" class="text-blue-500" :size="16" />
      </transition>
    </button>
      ...
      >
        ...
        <div class="switch-handle">
          <div class="handle-icon">
            <PhSun v-if="themeStore.themeMode === 'light'" class="text-amber-500" :size="14" />
            <PhMoon v-else-if="themeStore.themeMode === 'dark'" class="text-amber-400" :size="14" />
            <PhCircleHalf v-else class="text-white/90" :size="15" />
          </div>
        </div>
      </button>
    </div>
